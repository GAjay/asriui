      ...
      <div className="p-6 space-y-6">
        ...
        <section>
          <div className="mb-8">
            ...
            <div className="text-sm">This workspace's Paid Plan is set to <strong className="font-medium">$79</strong> per month and will renew on <strong className="font-medium">July 9, 2024</strong>.</div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-12 gap-6">
              {/* Tab 1 */}
              <div className="relative col-span-full xl:col-span-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 shadow-sm rounded-b-lg">
                ...
                <div className="px-5 pt-5 pb-6 border-b border-gray-200 dark:border-gray-700/60">
                  <header className="flex items-center mb-2">
                    ...
                    <h3 className="text-lg text-gray-800 dark:text-gray-100 font-semibold">Monk (Free)</h3>
                  </header>
                ...
                <div className="px-5 pt-4 pb-5">
                  ...
                  <ul>
                    <li className="flex items-center py-1">
                      ...
                      <div className="text-sm">8% per transaction fees (Platform Fees)</div>
                    </li>
                    <li className="flex items-center py-1">
                      <svg className="w-3 h-3 shrink-0 fill-current text-green-500 mr-2" viewBox="0 0 12 12">
                        <path d="M10.28 1.28L3.989 7.575 1.695 5.28A1 1 0 00.28 6.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 1.28z" />
                      </svg>
                      <div className="text-sm">2.5% per transaction (Payment Gateway Fees)</div>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="relative col-span-full xl:col-span-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 shadow-sm rounded-b-lg">
                ...
                <div className="px-5 pt-5 pb-6 border-b border-gray-200 dark:border-gray-700/60">
                  <header className="flex items-center mb-2">
                    ...
                    <h3 className="text-lg text-gray-800 dark:text-gray-100 font-semibold">Roshi (Paid)</h3>
                  </header>
                  <div className="text-sm mb-2">Ideal for individuals that need a custom solution with custom tools.</div>
                  {/* Price */}
                  <div className="text-gray-800 dark:text-gray-100 font-bold mb-4">
                    <span className="text-2xl">$</span><span className="text-3xl">{annual ? '800' : '79'}</span><span className="text-gray-500 font-medium text-sm">/mo</span>
                  </div>
                  {/* CTA */}
                ...
                <div className="px-5 pt-4 pb-5">
                  ...
                  <ul>
                    <li className="flex items-center py-1">
                      ...
                      <div className="text-sm">No Platform Fees</div>
                    </li>
                    <li className="flex items-center py-1">
                      <svg className="w-3 h-3 shrink-0 fill-current text-green-500 mr-2" viewBox="0 0 12 12">
                        <path d="M10.28 1.28L3.989 7.575 1.695 5.28A1 1 0 00.28 6.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 1.28z" />
              ...
              <div className="relative col-span-full xl:col-span-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 shadow-sm rounded-b-lg">
                ...
                <div className="px-5 pt-5 pb-6 border-b border-gray-200 dark:border-gray-700/60">
                  <header className="flex items-center mb-2">
                    ...
                    <h3 className="text-lg text-gray-800 dark:text-gray-100 font-semibold">Senshi (Paid)</h3>
                  </header>
                  <div className="text-sm mb-2">Ideal for individuals that need a custom solution with custom tools.</div>
                  {/* Price */}
                  <div className="text-gray-800 dark:text-gray-100 font-bold mb-4">
                    <span className="text-2xl">$</span><span className="text-3xl">{annual ? '1200' : '149'}</span><span className="text-gray-500 font-medium text-sm">/mo</span>
                  </div>
                  {/* CTA */}
              ...
              <div className="relative col-span-full xl:col-span-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 shadow-sm rounded-b-lg">
                ...
                <div className="px-5 pt-5 pb-6 border-b border-gray-200 dark:border-gray-700/60">
                  <header className="flex items-center mb-2">
                    ...
                    <h3 className="text-lg text-gray-800 dark:text-gray-100 font-semibold">Zen (Paid)</h3>
                  </header>
                  <div className="text-sm mb-2">Ideal for individuals that need a custom solution with custom tools.</div>
                  {/* Price */}
                  <div className="text-gray-800 dark:text-gray-100 font-bold mb-4">
