...
export default function ChannelDetails() {
    const breadcrumbs = ["Home", "Blog", "Slug"];
                ...
                <div className="max-w-5xl mx-auto flex flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
                    ...
                    <div>
                        <div className="bg-white dark:bg-gray-800 p-5 shadow-sm rounded-xl lg:w-[18rem] xl:w-[20rem]">
                            <div className="text-sm text-gray-800 dark:text-gray-100 font-semibold mb-3">Similar Blog</div>
                            <ul className="space-y-2 sm:flex sm:space-y-0 sm:space-x-2 lg:space-y-2 lg:space-x-0 lg:flex-col mb-4">
                                ...
                                <li>
                                    <button className="w-full h-full text-left py-3 px-4 rounded-lg bg-white dark:bg-gray-800 border-2 border-violet-400 dark:border-violet-500 shadow-sm transition">
                                        <div className="flex flex-wrap items-center justify-between mb-0.5">
                                            <span className="font-semibold text-gray-800 dark:text-gray-100">Premium <span className="text-xs italic text-violet-500 align-top">Tag</span></span>
                                        </div>
                                        <div className="text-sm">Lorem ipsum dolor sit amet elit sed do eiusmod.</div>
                                    </button>
                                </li>
                        ...
                        <nav className="mb-4 sm:mb-0 sm:order-1 pb-2" role="navigation" aria-label="Navigation">
                            <ul className="flex justify-center">
                                <li className="ml-3 first:ml-0">
                                    <Link className="btn bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-gray-800 dark:text-gray-300" href="/blogs">View All -&gt;</Link>
                                </li>
                            </ul>
                        </nav>
                        <div className="sm:mb-0">
                            <h2 className="text-xl leading-snug text-gray-800 dark:text-gray-100 font-bold">More Blogs</h2>
                        </div>
                    </div>
