function i(e){return t.find(a=>a.slug===e)}const t=[{slug:"watch-landing",title:"Watches landing",description:"Luxury product hero, animated collection grid, craft features, and conversion CTA.",layout:"centered",demoPath:"/templates/watch-landing",filename:"WatchLandingPage.tsx",code:`import { Badge, Button, PageLayout, Typography } from "asriui";
...
}`},{slug:"about",title:"About page",description:"Centered marketing page with hero, values grid, and team cards.",layout:"centered",demoPath:"/templates/about",filename:"AboutPage.tsx",code:`import { Badge, PageLayout, Typography } from "asriui";
import "asriui/style.css";
...
}`},{slug:"contact",title:"Contact page",description:"JSON-driven Form with topic select and contact info aside.",layout:"centered",demoPath:"/templates/contact",filename:"ContactPage.tsx",code:`import { Form, PageLayout, Typography } from "asriui";
import "asriui/style.css";
...
}`},{slug:"pricing",title:"Pricing page",description:"Three-tier pricing cards with FAQ accordion.",layout:"centered",demoPath:"/templates/pricing",filename:"PricingPage.tsx",code:`import { Accordion, Button, PageLayout, Typography } from "asriui";
import "asriui/style.css";
...
}`},{slug:"dashboard",title:"Dashboard page",description:"Sidebar shell with stats, DataGrid orders table, and activity timeline.",layout:"sidebar",demoPath:"/templates/dashboard",filename:"DashboardPage.tsx",code:`import { Badge, Button, DataGrid, Icon, PageLayout, SideNav, Timeline, Typography } from "asriui";
import "asriui/style.css";
...
}`},{slug:"login",title:"Login page",description:"OAuth + email LoginForm with toast feedback.",layout:"centered",demoPath:"/templates/login",filename:"LoginPage.tsx",code:`import { LoginForm, PageLayout, toast } from "asriui";
import "asriui/style.css";
...
}`},{slug:"shop",title:"Shop page",description:"Ecommerce product catalog with category filters and add-to-cart toasts.",layout:"centered",demoPath:"/templates/shop",filename:"ShopPage.tsx",code:`import { Badge, Button, PageLayout, Typography, toast } from "asriui";
import "asriui/style.css";
...
}`},{slug:"cart",title:"Cart page",description:"Line items with quantity controls, promo code, and order summary.",layout:"centered",demoPath:"/templates/cart",filename:"CartPage.tsx",code:`import { useState } from "react";
...
}`},{slug:"checkout",title:"Checkout page",description:"Schema-driven shipping Form with payment summary panel.",layout:"centered",demoPath:"/templates/checkout",filename:"CheckoutPage.tsx",code:`import { Form, PageLayout, Typography, toast } from "asriui";
import "asriui/style.css";
...
}`},{slug:"settings",title:"Settings page",description:"Sidebar account settings with Tabs, Form, Switch, and danger zone.",layout:"sidebar",demoPath:"/templates/settings",filename:"SettingsPage.tsx",code:`import { Form, Icon, PageLayout, SideNav, Switch, Tabs, Typography, toast } from "asriui";
import "asriui/style.css";
...
}`},{slug:"inbox",title:"Inbox page",description:"Message list with ListItem selection and a reading pane.",layout:"sidebar",demoPath:"/templates/inbox",filename:"InboxPage.tsx",code:`import { useState } from "react";
...
}`},{slug:"analytics",title:"Analytics page",description:"KPI cards, channel bars, and a Timeline of product signals.",layout:"sidebar",demoPath:"/templates/analytics",filename:"AnalyticsPage.tsx",code:`import { Badge, PageLayout, Timeline, Typography } from "asriui";
import "asriui/style.css";
...
}`},{slug:"billing",title:"Billing page",description:"Plan summary and invoice DataGrid for account billing.",layout:"sidebar",demoPath:"/templates/billing",filename:"BillingPage.tsx",code:`import { Badge, Button, DataGrid, PageLayout, Typography } from "asriui";
import "asriui/style.css";
...
}`},{slug:"team",title:"Team page",description:"Member directory with roles and invite action.",layout:"sidebar",demoPath:"/templates/team",filename:"TeamPage.tsx",code:`import { Badge, Button, List, ListItem, PageLayout, Typography } from "asriui";
import "asriui/style.css";
...
}`},{slug:"onboarding",title:"Onboarding page",description:"Multi-step workspace setup with Form schemas.",layout:"centered",demoPath:"/templates/onboarding",filename:"OnboardingPage.tsx",code:`import { useState } from "react";
...
}`},{slug:"json-page",title:"JSON Page builder",description:"Render a full screen from a serializable PageConfig.",layout:"sidebar",demoPath:"/templates/json-page",filename:"JsonPageDemo.tsx",code:`import { Page } from "asriui/page";
import "asriui/style.css";
...
}`},{slug:"ai-workflow",title:"AI workflow builder",description:"n8n-style canvas with templates, AsriUI blocks, scripts, and run preview.",layout:"centered",demoPath:"/templates/ai-workflow",filename:"AiWorkflowPage.tsx",code:`import { AiWorkflowBuilder } from "asriui/ai-workflow-builder";
...
}`},{slug:"ai-orchestrator",title:"AI orchestrator",description:"Summarizer, data analyst, form filler, semantic search, and multi-step pipeline in one shell.",layout:"centered",demoPath:"/templates/ai-orchestrator",filename:"AiOrchestratorPage.tsx",code:`import { AiOrchestrator } from "asriui/ai-orchestrator";
import { PageLayout } from "asriui/page-layout";
import "asriui/style.css";
...
}`}];export{t as T,i as g};
//# sourceMappingURL=templateSnippets-eIvemlIR.js.map
