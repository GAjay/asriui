...
export const SITE_DESCRIPTION =
  "AsriUI is an open-source React 18+ UI library for the web with accessible components, TypeScript, tree-shakable subpath imports, Framer Motion presets, docs with live examples, and installable PWA support. Pair the same tokens and TypeScript patterns with React Native apps while shipping web UI from the npm package.";
